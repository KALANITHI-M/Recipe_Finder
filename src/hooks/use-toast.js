 ...
 * @param {ToasterToast} [action.toast]
 ...
 * @returns {{ id: string, dismiss: function(): void, update: function(ToasterToast): void }}
 */
 ...
 * @returns {{ toasts: ToasterToast[], toast: function, dismiss: function(string=): void }}
 */
function useToast() {
