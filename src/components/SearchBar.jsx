...
/**
 * @param {Object} props
 * @param {function(string[]): void} props.onSearch - Callback function when search is performed
 * @param {function(): void} props.onRandom - Callback function when random button is clicked
 */
